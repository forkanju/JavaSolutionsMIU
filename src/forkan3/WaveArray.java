...
public class WaveArray {
	...
	public static void main(String[] args) {
		...
		int[] arr = {2,6,3,4};
		System.out.println(isWaveArrays(arr));
	}
	
	public static int isWaveArrays(int[] arr) {
...
arrays. But {2, 6, 3, 4} is not a wave array because the even numbers 2 and 6 are adjacent to
each other.
